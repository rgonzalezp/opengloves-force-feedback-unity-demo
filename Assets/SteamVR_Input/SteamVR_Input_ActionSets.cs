...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_Gesture p_Gesture;
        ...
        public static SteamVR_Input_ActionSet_Gesture Gesture
        {
            get
            {
                return SteamVR_Actions.p_Gesture.GetCopy<SteamVR_Input_ActionSet_Gesture>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_Gesture = ((SteamVR_Input_ActionSet_Gesture)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_Gesture>("/actions/Gesture")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.Gesture};
        }
    }
}
